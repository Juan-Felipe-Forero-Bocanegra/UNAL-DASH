...
dash.register_page(
    __name__, path='/compra-mobiliario-laboratorios')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Gestión de Laboratorios&programa_param=Proyectos de laboratorios&actividad_param=Compra de mobiliario en laboratorio con recursos de Facultad"
...
# Valor total de la compra de mobiliario en laboratorios con recursos de la facultad
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink("Compra de mobiliario en laboratorio", active=True,
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P("valor total de la compra"),
                                ]
                            ),
                        )
                    ], className='card_container'), lg=4),
    ...
    dcc.Graph(id="graph_directrices_solicitadas_compra_mobiliario_laboratorio",
              figure=px.bar(data,
                            x="cifra",
                            y="Facultad",
                            color="Año",
    ...
    html.H5('Valor total de las compras de mobiliario'),
    dcc.Graph(id="graph_valor_total_compra_mobiliario_laboratorio",
