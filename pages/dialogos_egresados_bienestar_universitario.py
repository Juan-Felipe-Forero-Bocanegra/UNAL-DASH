...
dash.register_page(
    __name__, path='/dialogos-egresados-bienestar-universitario')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Bienestar Universitario&programa_param=Programa de egresados&actividad_param=Dialogos con egresados"
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink("Dialogos con egresados", active=True,
    ...
    dcc.Graph(id="graph_egresadores_expositores_dialogo_egresados_bienestar_universitario",
    ...
    dcc.Graph(id="graph_egresadores_participantes_dialogo_egresados_bienestar_universitario",
        ...
        [
            dbc.Row(
                [
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="facultad_dialogos_egresados_bienestar_universitario",
                    ...
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="anio_dialogos_egresados_bienestar_universitario",
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_dialogos_egresados_bienestar_universitario',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
...
@callback(
    Output("logros_tabla_dialogos_egresados_bienestar_universitario", "data"),
    [Input("facultad_dialogos_egresados_bienestar_universitario", "value"), Input("anio_dialogos_egresados_bienestar_universitario", "value")])
def logros_alcanzados_dialogos_egresados_bienestar_universitario(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data
