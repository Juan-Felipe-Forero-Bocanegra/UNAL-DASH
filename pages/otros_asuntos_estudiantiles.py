...
dash.register_page(__name__, path='/otros-asuntos-estudiantiles')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Formación&programa_param=Asuntos estudiantiles&actividad_param=Otros"
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink("Otros",active=True,
    ...
    html.H5('Retiros del programa'),
    dcc.Graph(id="graph_retitros_programas_asuntos_estudiantiles",
    ...
    html.H5('Traslados'),
    dcc.Graph(id="graph_traslados_asuntos_estudiantiles",
    ...
    html.H5('Dobles titulaciones'),
    dcc.Graph(id="graph_dobles_titulaciones",
    ...
    html.H5('Permisos académicos'),
    dcc.Graph(id="graph_permisos_academicos",
