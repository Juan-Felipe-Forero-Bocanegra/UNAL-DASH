...
dash.register_page(__name__, path='/articulacion-interinstitucional_ICA')
...
url = environment + \
    "/reporte_cifras/buscarCifras?area_param=Investigación y Creación Artística&programa_param=Despliegue de la investigación &actividad_param=Articulación interistitucional"
    ...
    if c['informeActividadDetalle']['orden'] == 1:
        ...
        for a in c['informeActividadDetalle']['listaDatoListaValor']:
            ...
            if a['actividadDatoLista']['orden'] == '1':
                o['Instituciones participantes'] = a['cifra']
                i += 1
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink(
                "Articulación interistitucional", active=True, href="/articulacion-interinstitucional_ICA")),
        ...
        [
            dbc.Row(
                [
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="facultad_articulacion_interinstitucional_ICA",
                    ...
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="anio_articulacion_interinstitucional_ICA",
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_articulacion_interinstitucional_ICA',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
...
@callback(
    Output("logros_tabla_articulacion_interinstitucional_ICA", "data"),
    [Input("facultad_articulacion_interinstitucional_ICA", "value"), Input("anio_articulacion_interinstitucional_ICA", "value")])
def logros_alcanzados_articulacion_interinstitucional_ICA(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data
