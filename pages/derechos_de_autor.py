...
dash.register_page(__name__, path='/derechos-de-autor')

data = pd.read_excel(open(
    'pages/derechos_de_autor.xlsx', 'rb'), sheet_name='1')
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink('Derechos de autor', active=True, href="/derechos-de-autor")),
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_derechos_autor',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
...
@callback(
    Output("logros_tabla_derechos_autor", "data"),
    [Input("facultad_derechos_autor", "value"), Input("anio_derechos_autor", "value")])
def logros_alcanzados_derechos_autor(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data
