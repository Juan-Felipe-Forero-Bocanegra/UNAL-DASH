...
dash.register_page(__name__, path='/actualizacion-bases-datos-ICA')
...
url = environment + \
    "/reporte_cifras/buscarCifras?area_param=Investigación y Creación Artística&programa_param=Despliegue de la investigación &actividad_param=Actualización de bases de datos (Hermes y otras)"
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink(
                "Actualización de bases de datos (Hermes y otras)", active=True, href="/actualizacion-bases-datos-ICA")),
            dbc.NavItem(dbc.NavLink(
        ...
        [
            dbc.Row(
                [
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="facultad_actualizacion_bases_datos_ICA",
                    ...
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="anio_actualizacion_bases_datos_ICA",
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_actualizacion_bases_datos_ICA',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
...
@callback(
    Output("logros_tabla_actualizacion_bases_datos_ICA", "data"),
    [Input("facultad_actualizacion_bases_datos_ICA", "value"), Input("anio_actualizacion_bases_datos_ICA", "value")])
def logros_alcanzados_actualizacion_bases_datos_ICA(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data
