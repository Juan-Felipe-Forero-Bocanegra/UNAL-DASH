...
dash.register_page(
    __name__, path='/actividades-egresados-bienestar-universitario')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Bienestar Universitario&programa_param=Programa de egresados&actividad_param=Actividades con egresados"
        ...
        [
            dbc.Row(
                [
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="facultad_actividades_egresados_bienestar_universitario",
                    ...
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="anio_actividades_egresados_bienestar_universitario",
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_actividades_egresados_bienestar_universitario',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
...
@callback(
    Output("logros_tabla_actividades_egresados_bienestar_universitario", "data"),
    [Input("facultad_actividades_egresados_bienestar_universitario", "value"), Input("anio_actividades_egresados_bienestar_universitario", "value")])
def logros_alcanzados_actividades_egresados_bienestar_universitario(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data
