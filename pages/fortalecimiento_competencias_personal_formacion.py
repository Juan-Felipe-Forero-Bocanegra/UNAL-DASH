...
dash.register_page(
    __name__, path='/fortalecimiento-competencias-personal-formacion')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Formación&programa_param=Formación del personal docente y administrativo&actividad_param=Fortalecimiento de competencias del personal"
...
layout = html.Div([
    ...
    dcc.Graph(id="graph_capacitaciones_personal_docente_facultad_formacion",
    ...
    dcc.Graph(id="graph_numero_docentes_capacitaciones_facultad_formacion",
        ...
        [
            dbc.Row(
                [
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="facultad_fortalecimiento_competencias_personal_formacion",
                    ...
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="anio_fortalecimiento_competencias_personal_formacion",
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_fortalecimiento_competencias_personal_formacion',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
...
@callback(
    Output("logros_tabla_fortalecimiento_competencias_personal_formacion", "data"),
    [Input("facultad_fortalecimiento_competencias_personal_formacion", "value"), Input("anio_fortalecimiento_competencias_personal_formacion", "value")])
def logros_alcanzados_fortalecimiento_competencias_personal_formacion(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data
