...
dash.register_page(
    __name__, path='/contratacion-externa-mantenimietno-preventivo-laboratorios')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Gestión de Laboratorios&programa_param=Proyectos de laboratorios&actividad_param=Contratación externa de mantenimiento Preventivo de equipos básicos de laboratorio con recursos de Facultad"
...
# Valor total de la contratación externa de mantenimiento preventivo de equipos básicos de laboratorio
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink("Contratación externa de mantenimiento preventivo", active=True,
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "valor total de la contratación externa de mantenimiento preventivo"),
                                ]
                            ),
                        )
                    ], className='card_container'), lg=4),
    ...
    dcc.Graph(id="graph_directrices_solicitadas_contratacion_externa_mantenimiento_preventivo_laboratorio",
              figure=px.bar(data,
                            x="cifra",
                            y="Facultad",
                            color="Año",
    ...
    html.H5('Valor total de la contratación externa de mantenimiento preventivo'),
    dcc.Graph(id="graph_valor_total_contratacion_externa_mantenimiento_preventivo_laboratorio",
              figure=px.bar(data_2,
                            ...
                            labels={
                                'Facultad': 'Dependencia',
                                'cifra': 'Valor total de la contratación externa de mantenimiento preventivo'
                            },
