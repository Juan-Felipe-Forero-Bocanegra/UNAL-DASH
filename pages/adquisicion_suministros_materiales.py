...
dash.register_page(
    __name__, path='/adquisicion-suministros-materiales')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Gestión de Laboratorios&programa_param=Proyectos de laboratorios&actividad_param=Adquisición de suministros y materiales"
...
# Número de procesos de adquisición de suministros y materiales
...
# Valor total de los suministros y materiales adquiridos
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            ...
            dbc.NavItem(dbc.NavLink("Adquisición de suministros y materiales", active=True,
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "procesos de adquisición de suministros y materiales"),
                                ]
                            ),
                        )
    ...
    html.H5('Procesos de adquisición de suministros y materiales'),
    dcc.Graph(id="graph_adquisicion_suministros_materiales_laboratorio",
              figure=px.bar(data,
                            x="cifra",
                            y="Facultad",
                            color="Año",
                            labels={
                                ...
                                'cifra': 'Procesos de adquisición de suministros y materiales'
                            },
    ...
    html.H5('Valor total de los suministros y materiales adquiridos'),
    dcc.Graph(id="graph_valor_total_adquisicion_suministros_materiales_laboratorio",
              figure=px.bar(data_2,
                            ...
                            labels={
                                'Facultad': 'Dependencia',
                                'cifra': 'Valor total de los suministros y materiales adquiridos'
                            },
