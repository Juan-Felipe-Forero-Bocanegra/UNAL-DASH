...
dash.register_page(__name__, path='/cifras-proyectos-periodo')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Investigación y Creación Artística&programa_param=Proyectos de investigación&actividad_param=Cifras de proyectos en el periodo"
...
# Estudiantes apoyados en proyectos finalizados
...
# Semilleros apoyados en proyectos finalizados
...
# Investigadores apoyados en proyectos finalizados*
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            dbc.NavItem(dbc.NavLink("Cifras de proyectos en el periodo", active=True,
    ...
    html.H5('Estudiantes apoyados en proyectos finalizados'),
    dcc.Graph(id="graph_estudiantes_apoyados_proyectos_finalizados",
    ...
    html.H5('Semilleros apoyados en proyectos finalizados'),
    dcc.Graph(id="graph_semilleros_apoyados_proyectos_finalizados",
    ...
    html.H5('Investigadores apoyados en proyectos finalizados'),
    dcc.Graph(id="graph_investigadores_apoyados_proyectos_finalizados",
