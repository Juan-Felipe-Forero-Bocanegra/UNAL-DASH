...
dash.register_page(
    __name__, path='/movilidad-estudiantil-investigativa-ICA')

f = open("file.txt", "r")
token = f.readline()
e = open("environment.txt", "r")
environment = e.readline()
url = environment + "/reporte_cifras/buscarCifras?area_param=Investigación y Creación Artística&programa_param=Movilidad investigativa&actividad_param=Movilidad estudiantil"
...
movilidad_estudiantil_tmp = data[['Facultad', 'Año',
                                  'Estudiantes beneficiados']]
movilidad_estudiantil = movilidad_estudiantil_tmp.rename(
    columns={'Estudiantes beneficiados': 'cifra'})

movilidad_estudiantil['Año'] = movilidad_estudiantil['Año'].astype('str')
movilidad_estudiantil.fillna(0, inplace=True)
movilidad_estudiantil['cifra'] = movilidad_estudiantil['cifra'].astype('int')

movilidad_estudiantil = movilidad_estudiantil.groupby(
    ['Facultad', 'Año'])['cifra'].sum().reset_index()

movilidad_estudiantil.apply(lambda x: total_function(
    x['Facultad'], x['Año'], movilidad_estudiantil), axis=1)

total_movilidad_estudiantil = movilidad_estudiantil['cifra'].sum()


# movilidad de estudiantes por tipo

movilidad_tipo_tmp = data[[
    'Facultad', 'Año', 'Estudiantes beneficiados', 'Tipo']]
...
movilidad_nivel_tmp = data[[
    'Facultad', 'Año', 'Estudiantes beneficiados', 'Nivel']]
...
layout = html.Div([
    ...
    dbc.Nav(
        [
            dbc.NavItem(dbc.NavLink("Movilidad estudiantil investigativa", active=True,
                                    href='/movilidad-estudiantil-investigativa-ICA')),
            dbc.NavItem(dbc.NavLink("Movilidad docente investigativa",
                    ...
                    dbc.Col(html.Div([
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5(
                                        total_movilidad_estudiantil,
                                        className="card-number",
                                    ),
                                    html.P(
                                        "total movilidad estudiantil investigativa"),
                                ]
                            ),
                        )
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "movilidad estudiantil investigativa entrante"),
                                ]
                            ),
                        )
                    ], className='card_container'), lg=4),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "movilidad estudiantil investigativa saliente"),
                                ]
                            ),
                        )
                    ], className='card_container'), lg=4),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "movilidad estudiantil investigativa nacional"),
                                ]
                            ),
                        )
                    ], className='card_container'), lg=4),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.P(
                                        "movilidad estudiantil investigativa internacional"),
                                ]
                            ),
                        )
                    ], className='card_container'), lg=4),
    ...
    html.H5('Total de movilidad estudiantil investigativa'),
    dcc.Graph(id="graph_total_movilidad_estudiantil_investigativa",
              figure=px.bar(movilidad_estudiantil,
                            x="cifra",
                            y="Facultad",
                            color='Año',
                            labels={
                                'Facultad': 'Dependencia',
                                'cifra': 'Movilidad estudiantil investigativa'
                            },
    ...
    html.H5('Movilidad estudiantil investigativa entrante'),
    dcc.Graph(id="graph_movilidad_estudiantil_investigativa_entrante",
              figure=px.bar(movilidad_entrante,
                            ...
                            labels={
                                'Facultad': 'Dependencia',
                                'cifra': 'Movilidad estudiantil investigativa entrante'
                            },
    ...
    html.H5('Movilidad estudiantil investigativa saliente'),
    dcc.Graph(id="graph_movilidad_estudiantil_investigativa_saliente",
              figure=px.bar(movilidad_saliente,
                            ...
                            labels={
                                'Facultad': 'Dependencia',
                                'cifra': 'Movilidad estudiantil investigativa saliente'
                            },
                            color_discrete_sequence=px.colors.qualitative.G10,
                            hover_data={
                                "cifra": True,
    ...
    html.H5('Movilidad estudiantil investigativa nacional'),
    dcc.Graph(id="graph_movilidad_estudiantil_investigativa_nacional",
              figure=px.bar(movilidad_nacional,
                            ...
                            labels={
                                'Facultad': 'Dependencia',
                                'cifra': 'Movilidad estudiantil investigativa nacional'
                            },
                            color_discrete_sequence=px.colors.qualitative.Prism,
                            hover_data={
                                "cifra": True,
    ...
    html.H5('Movilidad estudiantil investigativa internacional'),
    dcc.Graph(id="graph_movilidad_estudiantil_investigativa_internacional",
              figure=px.bar(movilidad_internacional,
                            ...
                            labels={
                                'Facultad': 'Dependencia',
                                'cifra': 'Movilidad estudiantil investigativa internacional'
                            },
                            color_discrete_sequence=px.colors.qualitative.Prism,
                            hover_data={
                                "cifra": True,
        ...
        [
            dbc.Row(
                [
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="facultad_movilidad_estudiantil_investigativa_estudiantes",
                    ...
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="anio_movilidad_estudiantil_investigativa_estudiantes",
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_movilidad_estudiantil_investigativa_estudiantes',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
        ...
        [
            dbc.Row(
                [
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="facultad_movilidad_estudiantil_investigativa_logros",
                    ...
                    dbc.Col(html.Div([
                        dcc.Dropdown(
                            id="anio_movilidad_estudiantil_investigativa_logros",
                    ...
                    dbc.Col(
                        html.Div([
                            dash_table.DataTable(
                                ...
                                id='logros_tabla_movilidad_estudiantil_investigativa_logros',
                            ),
                        ], style={'paddingTop': '2%'})
                    )
                ]
...
@callback(
    Output("logros_tabla_movilidad_estudiantil_investigativa_estudiantes", "data"),
    [Input("facultad_movilidad_estudiantil_investigativa_estudiantes", "value"), Input("anio_movilidad_estudiantil_investigativa_estudiantes", "value")])
def logros_alcanzados_movilidad_estudiantil_investigativa_estudiantes(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data
...
@callback(
    Output("logros_tabla_movilidad_estudiantil_investigativa_logros", "data"),
    [Input("facultad_movilidad_estudiantil_investigativa_logros", "value"), Input("anio_movilidad_estudiantil_investigativa_logros", "value")])
def logros_alcanzados_movilidad_estudiantil_investigativa_logros(facultad, anio):
    if facultad or anio:
        if not anio:
            df = data_logros
            df = df[df['Facultad'] == facultad]
